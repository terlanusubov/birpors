...
namespace Birpors.Infrastructure.Migrations
{
    ...
    [Migration("20230329143718_signalrmodelsadded")]
    partial class signalrmodelsadded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Birpors.Domain.Entities.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Birpors.Domain.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Birpors.Domain.Entities.Participant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Birpors.Domain.Entities.Message", b =>
                {
                    b.HasOne("Birpors.Domain.Entities.Conversation", "Conversation")
                        .WithMany("Messages")
