...
namespace Birpors.API.Chat
{
    ...
    public class ChatHub : Hub
    {
        ...
        public ChatHub(ChatClientManager _clientManager, IApplicationDbContext _context)
        {
        ...
        //        Url = $"https://birpors.azurewebsites.net/chatHub",
        //    };
        ...
        public async Task<bool> HasMessage()
        {
            ...
            if (await context.Participants.AnyAsync(p => p.AppUserId == Convert.ToInt32(userId) && !p.HasGettedConversation))
                return true;
            else
                return false;
